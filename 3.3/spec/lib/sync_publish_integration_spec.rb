...
describe "Sync Publish Integration Test" do
    ...
    context "with basic publish config" do
      ...
      it "should publish without ssl" do
        ...
        VCR.use_cassette("integration_publish_1", :record => :none) do
          @pn.publish(:channel => :hello_world, :message => "hi", :callback => @my_callback).should == my_response
        end
      end
      ...
      it "should publish without ssl with custom origin" do
        ...
        VCR.use_cassette("integration_publish_10", :record => :none) do
          @pn.publish(:origin => "a.pubnub.com", :channel => :hello_world, :message => "hi", :callback => @my_callback).should == my_response
        end
      end
